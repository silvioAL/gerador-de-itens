  ...
  return (
    <div style={containerEstilo}>
      ...
      <div style={conteudoEstilo}>
        <h1 style={{ fontSize: 24, color: "#0f172a", margin: "0 0 6px" }}>Do diagrama ao backlog, sem inventar nada</h1>
        <p style={{ fontSize: 14, color: "#475569", lineHeight: 1.6, maxWidth: 640, marginBottom: 32 }}>
          Não é um gerador de prompt de IA — é um mecanismo determinístico. O mesmo diagrama sempre produz o mesmo
          backlog, com proveniência em cada campo e nada virando "pronto" sem alguém confirmar.
        </p>
        <Jornada />
