...
describe("validarEscritaFluxos (SPEC-35 + prova da fatia C)", () => {
  ...
  it.each([
    ...
    [
      ...
      /a função "telepatia", que não existe \(funções: derivacao, ensaio, pdca-feedback, gerar-spec, pdca-ler-feedbacks, config-ler, config-propor-ajuste, config-aplicar-ajuste\)/,
    ],
