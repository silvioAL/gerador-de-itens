...
# $env:GERADOR_REPO) só quando não há instalação global — útil enquanto se
# desenvolve o próprio `gerador` dentro deste repositório.
param(
...
$repo = if ($env:GERADOR_REPO) { $env:GERADOR_REPO } else { "C:\Users\silvi\Documents\gerador" }
